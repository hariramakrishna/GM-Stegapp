	...
	"use strict";
		...
		$.extend(Plugin.prototype, {
		        ...
		        updateOriginalInput:function(){
		        	var newValue = "";
		        	$('.pincode-input-text1',this._container).each(function( index, value ) {
		    	...
		    	this._container = $('<div />').addClass('pincode-input-container1');
					...
					if(this._isTouchDevice()){
						var input = $('<input>').attr({'type':'number','pattern': "[0-9]*", 'inputmode':"numeric",'maxlength':this.settings.inputs,'autocomplete':'off'}).addClass('form-control1 pincode-input-text1 first1 last1 mobile1').appendTo(this._container);
		        		if(this.settings.hidedigits){
									// hide digits
			        	...
			        	for (var i = 0; i <  this.settings.inputs; i++) {
			        		...
			        		var input = $('<input>').attr({'type':'number','maxlength':"1",'autocomplete':'off'}).addClass('form-control1 pincode-input-text1').appendTo(this._container);
			        		if(this.settings.hidedigits){
										// hide digits
			        			input.attr('type','password');
			        		}else{
			        		...
			        		if(i==0){
			        			input.addClass('first1');
			        		}else if(i==(this.settings.inputs-1)){
			        			input.addClass('last1');
			        		}else{
			        			input.addClass('mid1');
			        		}
		        	...
		        	// error box
		        	this._error = $('<div />').addClass('text-danger pincode-input-error1').appendTo(this._container);
				...
				focus:function(){
					$('.pincode-input-text1',this._container).first().select().focus();
				},
				clear:function(){
					 $('.pincode-input-text1',this._container).each(function( index, value ) {
		         		$(value).val("");
